                ...
                <div className="relative mx-auto flex max-w-screen-lg flex-col py-4 md:flex-row md:items-center md:justify-between ">
                    ...
                    <nav aria-label="Header-Navigation" className="peer-checked:block hidden py-6 md:block md:py-0 text-center">
                        <ul className="flex flex-col gap-y-4 md:flex-row md:gap-x-8 md:items-center">
                            <li>
                                <a href="/" className={` ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} hover:text-cyan-500 transition-colors block`}>
                                    Home
                                </a>
                            </li>
                            <li>
                                <a href="/perfil" className={` ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} hover:text-cyan-500 transition-colors block`}>
                                    Perfil
                                </a>
                            </li>
                            <li>
                                <a href="/notas" className={` ${isDarkMode ? 'text-gray-200' : 'text-gray-700'} hover:text-cyan-500 transition-colors block`}>
                                    Mis Notas
                                </a>
                            </li>
                            <li>
